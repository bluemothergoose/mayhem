  ...
  <div class="spell-details">
    ...
    <div class="row spell-features">
      ...
      <div class="col-6 col-lg-4 col-xl-3">
        ...
        <template v-if="spell.atHigherLevel"><img :src="require('@/assets/images/icons/spell_features/scalable.png')" title="Spell requires a focus check."/> Focus check required</template>
      </div>
    ...
    <div v-if="spell.cost" v-html="prettyCost" class="spell-description">
    </div>
    <div v-if="spell.damage" v-html="prettyDamage" class="spell-description">
    </div>
    <div class="spell-description" v-if="spell.effect" v-html="prettyEffect"></div>
...
export default {
  ...
  computed: {
    ...
    prettyCost() {
      return TextBeautifier.beautify(this.spell.cost);
    },
    prettyDamage() {
      return TextBeautifier.beautify(this.spell.damage);
    },
    prettyEffect() {
      return TextBeautifier.beautify(this.spell.effect);
    },
    prettyHigherLevel() {
