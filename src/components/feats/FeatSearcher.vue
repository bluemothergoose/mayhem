    ...
    <div class="col-12 col-lg-6 query-area pr-2">
      ...
      <div class="search-actions">
        ...
        <span class="d-none d-md-inline-block" @click="$emit('toggleDetailedView')">
          <img :src="require('@/assets/images/icons/misc/details.png')" :class="`details-icon ${detailedModeOn ? 'active' : ''}`" title="Toggle detailed feat list"/>
        </span>
...
export default {
  ...
  watch: {
    rawQueryText: function() {
      ...
      debounce(() => {
        // If the query starts with a period, it means the user wants to search in the feat description too
