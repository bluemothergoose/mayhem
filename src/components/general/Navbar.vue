      ...
      <template v-if="app.spells.length > 0">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            ...
            <b-nav-item to="/feats"><img :src="require('@/assets/images/icons/menu/feats.png')"/> Feats</b-nav-item>
            <b-nav-item to="/abilities"><img :src="require('@/assets/images/icons/menu/abilities.png')"/> Abilities</b-nav-item>
            <b-nav-item to="/rules"><img :src="require('@/assets/images/icons/menu/rules.png')"/> Rules</b-nav-item>
            <b-nav-item to="/knowledges"><img :src="require('@/assets/images/icons/menu/knowledges.png')"/> Knowledges</b-nav-item>
            <b-nav-item-dropdown :html="`<img src='${require('@/assets/images/icons/menu/race.png')}'/> Races`">
              <b-dropdown-item to="/races/angel"><img :src="require('@/assets/images/icons/menu/angel.png')"/> Angel</b-dropdown-item>
              <b-dropdown-item to="/races/derathian"><img :src="require('@/assets/images/icons/menu/derathian.png')"/> Derathian</b-dropdown-item>
              <b-dropdown-item to="/races/evolution"><img :src="require('@/assets/images/icons/menu/evolution.png')"/> Evo Demon</b-dropdown-item>
              <b-dropdown-item to="/races/hell"><img :src="require('@/assets/images/icons/menu/hell.png')"/> Hell Demon</b-dropdown-item>
              <b-dropdown-item to="/races/human"><img :src="require('@/assets/images/icons/menu/human.png')"/> Human</b-dropdown-item>
              <b-dropdown-item to="/races/lycan"><img :src="require('@/assets/images/icons/menu/lycan.png')"/> Lycan</b-dropdown-item>
              <b-dropdown-item to="/races/mutation"><img :src="require('@/assets/images/icons/menu/mutation.png')"/> Mutation Demon</b-dropdown-item>
              <b-dropdown-item to="/races/saitorian"><img :src="require('@/assets/images/icons/menu/saitorian.png')"/> Saitorian</b-dropdown-item>
              <b-dropdown-item to="/races/vampire"><img :src="require('@/assets/images/icons/menu/vampire.png')"/> Vampire</b-dropdown-item>
            </b-nav-item-dropdown>
