...
class Icons {
  ...
  static categoryIcon(feat) {
    return require(`@/assets/images/icons/categories/${feat.category}.png`);
  }
  ...
  static castingIcon(spell) {
    ...
    if (casting.includes("free")) {
      name = "free";
    } else if (casting.includes("counter")) {
      name = "counter";
    } else if (casting.includes("action")) {
      name = "action";
    } else if (casting.includes("swift")) {
      name = "swift";
    }
     else {
      name = "full";
